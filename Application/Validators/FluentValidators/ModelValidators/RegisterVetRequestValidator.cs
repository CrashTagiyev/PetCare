...
{
	public class RegisterVetRequestValidator : AbstractValidator<RegisterVetRequest>
	{
		private readonly IAppUserReadRepository _appUserReadRepository;
		private readonly UserManager<AppUser> _userManager;
		public RegisterVetRequestValidator(IAppUserReadRepository appUserReadRepository, UserManager<AppUser> userManager)
		{
			...
			RuleFor(x => x.DateOfBirth)
			    ...
			    .Must(d => d.Value.Year > 1900 && d.Value.Year < DateTime.UtcNow.Year - 18).WithMessage("Invalid date of birth.");
			...
			RuleFor(x => x.ProficientPetTypesIds)
				.NotEmpty();
